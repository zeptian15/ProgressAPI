        ...
        <div class="column is-10">
            <div class="columns">
                <div class="column is-12 has-card-shadow p20">
                    <h1 class="title is-5">Laporan</h1>
                </div>
            </div>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="columns">
                                                <div class="column is-6">
                                                    <div class="columns">
                                                        <div class="column is-12">
                                                            <h1 class="title is-7">Laporan</h1>
                                                            @if($progress->berkas_laporan != null)
                                                            @if($progress->berkas_laporan == "-")
                                                ...
                                                <div class="column is-6">
                                                    <div class="columns">
                                                        <div class="column is-12">
                                                            <h1 class="title is-7">Verifikasi</h1>
                                                            @if($progress->berkas_verifikasi != null)
                                                            @if($progress->berkas_verifikasi == "-")
                                                            <h1 class="subtitle is-6 has-text-danger">
                                                                <b>Belum Ada</b></h1>
                                                            @else
                                                            <h1 class="subtitle is-6 has-text-success">
                                            ...
                                            <div class="columns">
                                                <div class="column is-12">
                                                    <a href="{{url('/berkas/upload/' . $progress->id)}}"
                                                        class="button input has-gradient-blue has-text-white">Upload
                                                        Berkas</a>
                                                    <a href="{{url('/berkas/update/' . $progress->id)}}"
                                                        class="button input has-gradient-green has-text-white">Update
                                                        Berkas</a>
                                                </div>
                                            </div>
                                        </div>
